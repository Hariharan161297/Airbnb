...
username = "Hariharan"
password = "Hari@161297"
# URL-encode the username and password
username = urllib.parse.quote_plus(username)
password = urllib.parse.quote_plus(password)
# Create the MongoDB URI with the encoded username and password
uri = f"mongodb+srv://{username}:{password}@cluster0.f5mticz.mongodb.net/?retryWrites=true&w=majority"
# Create the MongoClient
client_atlas = MongoClient(uri)

db = client_atlas["sample_airbnb"]
col = db["listingsAndReviews"]

# READING THE CLEANED DATAFRAME
df = pd.read_csv("H:\\Airbnb\\Airbnb_data.csv")

# HOME PAGE
if selected == "Home":
    # Title Image
    image = Image.open(r"H:\Airbnb\airbnb.png")
